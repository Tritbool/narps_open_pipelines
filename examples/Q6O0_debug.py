...
def main():
    ...
    matlab_cmd = '/opt/narps/spm12_2023b/run_spm12.sh /opt/MATLAB/MATLAB_Runtime/R2023b script'
    spm.SPMCommand.set_mlab_paths(matlab_cmd=matlab_cmd, use_mcr=True)
    team_ID = "Q6O0"
    # Important directories
    ## exp_dir : where the data are stored
    exp_dir = '/Users/michel/workspace/narps_open_pipelines/data/original/ds001734/'

    ## result_dir : where the intermediate and final results will be store
    result_dir = "/Users/michel/workspace/narps_open_pipelines/data/reproduced/"
